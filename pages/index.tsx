    ...
    <div  > 
      ...
      <main className={styles.main}>
        ...
        <div className={styles.content}>
          ...
          <span className={styles.address__container}> <button type="button" className={`${styles.locate_btn} ${Cookies.get('location') && styles.remove_location_btn}`} onClick={!Cookies.get('location')?handleGetLocation:removeLocation}><span>{button_label}</span> {!Cookies.get('location') && <FiMapPin/>}</button></span>
          </div>
